...
res_table_unshrunken <- results(ADdds, contrast=contrast_, alpha = 0.05, lfcThreshold = 0.6)
...
write.csv(sigOE, file="results/AD_VS._Old_DEGslfc0.6.csv")
```
...
jpeg(file="results/AD_VS._Old_DEGsHeatMaplfc0.6.png")
