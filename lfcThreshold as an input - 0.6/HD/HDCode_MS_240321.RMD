...
res_table_unshrunken <- results(HDdds, contrast=contrast_, alpha = 0.05, lfcThreshold = 0.6)
...
write.csv(sigOE, file="results/HD_VS._control_DEGslfc0.6.csv")
```
...
```{r}
write.csv(df.out, file="results/HD_VS._control_ConvertedDEGslfc0.6.csv")
...
jpeg(file="results/HD_VS._control_DEGsHeatMaplfc0.6_MS.png")
