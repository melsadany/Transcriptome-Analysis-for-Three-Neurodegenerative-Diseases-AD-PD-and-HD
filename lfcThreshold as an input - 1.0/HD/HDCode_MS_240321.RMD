...
res_table_unshrunken <- results(HDdds, contrast=contrast_, alpha = 0.05, lfcThreshold = 1)
...
#write.csv(sigOE, file="results/HD_VS._control_DEGslfc1.0.csv")
```
...
```{r}
write.csv(df.out, file="results/HD_VS._control_ConvertedDEGslfc1.0.csv")
...
jpeg(file="results/HD_VS._control_DEGsHeatMaplfc1.0_MS.png")
