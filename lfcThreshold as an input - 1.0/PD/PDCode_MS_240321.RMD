...
res_table_unshrunken <- results(PDdds, contrast=contrast_, alpha = 0.05, lfcThreshold = 1)
...
write.csv(sigOE, file="results/PD_VS._control_DEGslfc1.0.csv")
```
...
```{r}
write.csv(df.out, file="results/PD_VS._control_ConvertedDEGslfc1.0.csv")
